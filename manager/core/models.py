...
#Modelo para personal
class Personal(models.Model):
    idPersona = models.IntegerField(primary_key=True, verbose_name='ID Persona')
    ...
    fechaNacimiento = models.CharField(max_length=30, verbose_name='Fecha de nacimiento', null=True)
